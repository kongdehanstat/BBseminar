...
|-|-|-|-|
| Sep 16 |  | Two applications of LLMs in data science |  Overview of two works in progress: 1) comparing different LLMs on a specific data science analysis, 2) comparing LLMs on a broad data science analysis|
| Sep 23 | 	no meeting |  |   |
| Sep 30 |  	no meeting | | |
